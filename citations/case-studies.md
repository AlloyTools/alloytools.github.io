...
| [Chief Chefs of Z to Alloy: Using a Kitchen Example to Teach Alloy with Z](https://www.di.uminho.pt/tfm09/TFM09slides/3.2%20-%20Tarkan/TFM09tarkan.pdf)|Teaching Formal Methods | S Tarkan... - 2009 |
| [Workshop-modeling software the alloy way](https://ieeexplore.ieee.org/document/6684771)|Frontiers in Education Conference (FIE) | MJ Lutz..., 2013 |
| [Experiences of Teaching a Lightweight Formal Method](https://wrap.warwick.ac.uk/60398/1/WRAP_Boyatt_formed.pdf)| Electronic Notes in Theoretical Computer Science | RC Boyatt..., 2008 |
...
|[Experiences with Alloy in undergraduate formal methods](https://peer.asee.org/experiences-with-alloy-in-undergraduate-formal-methods.pdf)| | M Lutz - 2006|
...
| [An Example of a Hierarchical System Model Using SEAM and its Formalization in Alloy](https://www.semanticscholar.org/paper/An-Example-of-a-Hierarchical-System-Model-Using-and-Wegmann-L%C3%AA/c1cbb35258ba1c037a5d53cb0bc3145e64d7df4a)|EDOC Workshop| A Wegmann, LS Le, I Rychkova..., 2007|
...
| ------------------------ | ------------| ------------|
| [Mondex, an electronic purse: specification and refinement checks with the Alloy model-finding method](http://www.normalesup.org/~ramanana/research/mondex/tex/bigone.pdf)|Formal Aspects of Computing, 2008 - Springer | T Ramananandro |
| [An aspect oriented model of efficient and secure card-based payment system](https://dl.acm.org/citation.cfm?id=1948056)|Proceedings of the 2011 International Conference | DP Nigam... |
...
| [Modeling partial attacks with Alloy](https://www.semanticscholar.org/paper/Modeling-Partial-Attacks-with-Alloy-Lin-Bond/de2bc1f15dc9d9dd3b1bad79e4fb3b70adc5759c)|Security Protocols, 2010 - Springer | A Lin, M Bond...|
| [Lightweight Modeling of Java Virtual Machine Security Constraints](https://open.bu.edu/handle/2144/1723)| Abstract State Machines, Alloy, B and Z, 2010 - Springer | M Reynolds |
| [Using Lightweight Formal Methods for JavaScript Security](https://open.bu.edu/handle/2144/3798)| | M Reynolds - 2010 - cs.bu.edu|
| [A Lightweight Formal Analysis of a Multicast Key Management Scheme](https://asa.iti.kit.edu/taghdiri_forte03.pdf)| IFIP Lecture Notes in Computer Science (LNCS), 2011 - dl.ifip.org  | D Jackson...|
| [A security domain model for implementing Trusted Subject Behaviors](http://ceur-ws.org/Vol-413/paper03.pdf)| | M Auguston, A Shaffer - 2008|
|[Formal Models of a Least Privilege Separation Kernel in Alloy](https://calhoun.nps.edu/handle/10945/7158)| | M Auguston, TE Levin... - 2008 |
| [A security domain model for static analysis and verification of software programs](https://faculty.nps.edu/abshaffe/docs/SEKE08-Shaffer.pdf)| 2007 - DTIC Document | A Shaffer |
...
|[Using Automated Model Analysis for Reasoning about Security of web protocols](https://dl.acm.org/doi/10.1145/2420950.2420993)||Apurva Kumar - 2012 - IBM Research India|
|[Rigorous Analysis of UML Access Control Policy Models](https://ieeexplore.ieee.org/document/5976790)||W Sun, R France... - Policies for Distributed Systems and ..., 2011 - ieeexplore.ieee.org|
| [Automatic conformance checking of role-based access control policies via alloy](https://link.springer.com/chapter/10.1007/978-3-642-19125-1_2)||D Power, M Slaymaker... - Engineering Secure Software and ..., 2011 - Springer|
...
|[Enabling verification and conformance testing for access control model](https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.682.5555&rep=rep1&type=pdf)| Proceedings of the 13th ACM Symposium on Access ..., 2008 - dl.acm.org|H Hu...|
|[Verification of policy-based self-managed cell interactions using alloy](https://ieeexplore.ieee.org/document/5197381)|Filho, E Lupu, M Sloman... - ... and Networks, 2009\. ..., 2009 - ieeexplore.ieee.org|A Schaeffe|
...
|[Formal verification of OAuth 2.0 using Alloy framework](https://www.researchgate.net/publication/214826971_Formal_Verification_of_OAuth_20_Using_Alloy_Framework)| ... Systems and Network ..., 2011 - ieeexplore.ieee.org|S Pai, Y Sharma, S Kumar...|
|[Conformance verification of privacy policies](http://citeseerx.ist.psu.edu/viewdoc/download;jsessionid=9BC3EFCDD23CFD61F70178EC5D908011?doi=10.1.1.303.447&rep=rep1&type=pdf)| Web Services and Formal Methods, 2011 - Springer|X Fu|
|[Formalising and validating RBAC-to-XACML translation using lightweight formal methods](https://www.springerprofessional.de/en/formalising-and-validating-rbac-to-xacml-translation-using-light/3262276) |Abstract State Machines, Alloy, B ..., 2010 - Springer |M Slaymaker, D Power... |
|[A Formal Method Based Case Study for Access Control](https://ieeexplore.ieee.org/document/5376159) |Computational Intelligence and ..., 2009 |G Li, Y Xiao, M Lu... - |
|[On the modelling and analysis of Amazon Web Services access policies](https://www.researchgate.net/publication/221612268_On_the_Modelling_and_Analysis_of_Amazon_Web_Services_Access_Policies)| A Proof based approach ..., 2009| D Power, A Simpson...|
...
|[An Application of Alloy to Static Analysis for Secure Information Flow and Verification of Software Systems](https://calhoun.nps.edu/handle/10945/10320)| 2008 - DTIC Document|AB Shaffer|
...
|[Feature and class models in Clafer: Mixed, specialized, and coupled](https://cs.uwaterloo.ca/research/tr/2010/CS-2010-10.pdf)| ... on Software Language ..., 2010 - cs.uwaterloo.ca|K Bak, K Czarnecki...|
|[Detecting dependences and interactions in feature-oriented design](https://www.infosun.fim.uni-passau.de/cl/publications/docs/ISSRE2010.pdf)| ... (ISSRE), 2010 IEEE ..., 2010 - ieeexplore.ieee.org|S Apel, W Scholz, C Lengauer...|
|[Variability modeling and qos analysis of web services orchestrations](https://hal.inria.fr/docs/00/56/11/64/PDF/Kattepur2010.pdf)| Web Services (ICWS), ..., 2010 - ieeexplore.ieee.org|A Kattepur, S Sen, B Baudry...|
...
|[Verification of DSMLs using graph transformation: a case study with Alloy](https://dl.acm.org/doi/10.1145/1656485.1656488)| ... Workshop on Model-Driven ..., 2009 - dl.acm.org|Z Demirezen, M Mernik, J Gray...|
...
|[Formalizing train control language: automating analysis of train stations](https://www.researchgate.net/publication/271440330_Formalizing_train_control_language_automating_analysis_of_train_stations) | in Railways XII: ..., 2010 |A Svendsen, B Møller-Pedersen... |

## File Systems

| ------------------------ | ------------|------------|
|[Formal modeling and analysis of a flash filesystem in Alloy](https://eskang.github.io/assets/papers/abz08_kang_jackson.pdf)| Abstract state machines, B and Z, 2008 - Springer|E Kang...|
|[Variations on an Alloy-centric tool-chain in verifying a journaled file system model](https://www.di.uminho.pt/~jno/ps/TR-10-07.pdf)| 2010 - di.uminho.pt|MA Ferreira...|
|[Verifying Intel flash file system core specification](https://www4.di.uminho.pt/~jno/ps/overture08sl.pdf)| ... in VDM: Proceedings of the Fourth ..., 2008 - cs.ncl.ac.uk|MA Ferreira, SS Silva...|
...
| [Monarch: Model-based development of software architectures](https://link.springer.com/chapter/10.1007/978-3-642-16129-2_27?noAccess=true) | Model Driven Engineering Languages and ..., 2010 - Springer |H Bagheri, K Sullivan|
|[Dynamic software architectures verification using DynAlloy](https://journal.ub.tu-berlin.de/index.php/eceasst/article/viewFile/145/139)| Electronic Communications of ..., 2008 - journal.ub.tu-berlin.de|A Bucchiarone...|
|[A formal specification of the Fractal component model in Alloy](https://hal.inria.fr/docs/00/33/89/87/PDF/Fractal-Alloy.pdf)| 2008 - hal.inria.fr|P Merle, JB Stefani|
| [Assessing Component's Behavioral Interoperability Concerning Goals](https://dl.acm.org/doi/10.1007/978-3-540-88875-8_67) |On the Move to Meaningful Internet Systems: ..., 2008 - Springer |W Ma, L Chung... - |
|[A middleware model in alloy for supply chain-wide agent interactions](https://lirias2repo.kuleuven.be/bitstream/handle/123456789/297708/haesevoets.pdf;jsessionid=80BA680C4307D6132852439FA72B03AC?sequence=1)| Agent-Oriented ..., 2011 - Springer|R Haesevoets, D Weyns, M Cruz Torres...|
| [Modeling and analyzing architectural change with alloy](https://dl.acm.org/citation.cfm?id=1774560) | Proceedings of the 2010 ACM Symposium on ..., 2010 - dl.acm.or | KM Hansen... g|
| [Modeling and analysis of Reo connectors using Alloy](https://link.springer.com/chapter/10.1007/978-3-540-68265-3_11) | ... Models and Languages, 2008 - Springer |R Khosravi, M Sirjani, N Asoudeh, S Sahebi... |
|[Graph-based design and analysis of dynamic software architectures](https://link.springer.com/chapter/10.1007/978-3-540-68679-8_4)| ... , Graphs and Models, 2008 - Springer|R Bruni, A Bucchiarone, S Gnesi, D Hirsch...|
|[Towards self-management in service-oriented computing with modes](https://www.researchgate.net/publication/221050383_Towards_Self-management_in_Service-Oriented_Computing_with_Modes)| Service-Oriented Computing- ..., 2009 - Springer|H Foster, S Uchitel, J Kramer...|
|[Dynamic software architectures for global computing systems](http://e-theses.imtlucca.it/11/1/Bucchiarone_phdthesis.pdf)| 2008 - soa.fbk.eu|A Bucchiarone|
|[A model transformation approach to derive architectural models from goal-oriented requirements models](https://www.cin.ufpe.br/~jhcp/publica/iwssa2009cr.pdf)| On the Move to ..., 2009 - Springer|M Lucena, J Castro, C Silva, F Alencar...|
|[Specifying Self-configurable Component-Based Systems with FracToy](https://hal.inria.fr/docs/00/51/24/42/PDF/fractoy.pdf)| Abstract State Machines, Alloy, B ..., 2010 - Springer|A Tiberghien, P Merle...|
|[Analyzing architectural styles](https://kilthub.cmu.edu/articles/journal_contribution/Analyzing_Architectural_Styles/6603509)| Journal of Systems and Software, 2010 - Elsevier|JS Kim...|
| [Verification of replication architectures in AADL](https://ieeexplore.ieee.org/xpls/abs_all.jsp?arnumber=5090549) | Engineering of Complex Computer ..., 2009 |D de Niz... g|
| [Architectural style as an independent variable](https://dl.acm.org/citation.cfm?id=1858996.1859026) |Proceedings of the IEEE/ACM ..., 2010 |H Bagheri, Y Song... |
...
| [Alloy as a Refactoring Checker?](https://www.sciencedirect.com/science/article/pii/S1571066108003587) |  Electronic Notes in Theoretical Computer ..., 2008 - Elsevier |H Estler, H Wehrheim|
|[Sound Object Model Refactorings](https://twiki.cin.ufpe.br/twiki/pub/SPG/GroupPublications/fm2006.pdf)| 2010 - toritama.cin.ufpe.br|R Gheyi...|
|[Toward a Formal Evaluation of Refactorings](https://ntrs.nasa.gov/api/citations/20080022222/downloads/20080022222.pdf)| Formal Methods ..., 2008 - shemesh.larc.nasa.gov|J Paul, N Kuzmina, R Gamboa...|
|[Formal model-driven program refactoring](https://twiki.cin.ufpe.br/twiki/pub/SPG/GroupPublications/fase2008.pdf)| Proceedings of the Theory and practice ..., 2008 - dl.acm.org|T Massoni, R Gheyi...|
...
|[A Security Domain Model for Static Analysis and Verification of Software Programs](https://faculty.nps.edu/abshaffe/docs/SEKE08-Shaffer.pdf)| Proceedings of the 20th ..., 2008 |AB Shaffer, M Auguston, C Irvine...|
...
|[Analysis of invariants for efficient bounded verification](https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.184.3986&rep=rep1&type=pdf)| Proceedings of the 19th ..., 2010 - dl.acm.org|JP Galeotti, N Rosner, CG Lopez Pombo...|
| [Automatic code generation and solution estimate for object-oriented embedded software](https://dl.acm.org/citation.cfm?id=1449903) |Companion to the 23rd ACM SIGPLAN conference on ..., 2008 |RR Ferreira |
...
|[An Abstraction-Oriented, Path-Based Approach for Analyzing Object Equality in Java](https://www.researchgate.net/publication/221200120_An_Abstraction-Oriented_Path-Based_Approach_for_Analyzing_Object_Equality_in_Java)| Reverse Engineering (WCRE), 2010 ..., 2010 - ieeexplore.ieee.org|CR Rupakheti...|
...
|Solving Clafer Models with Choco||Jimmy Liang - 2012 _- GSDLab-TR_|
...
|[A manifesto for semantic model differencing](https://arxiv.org/pdf/1409.2485.pdf)| Models in Software Engineering, 2011 - Springer|S Maoz, J Ringert...|
|[A lightweight approach for defining the formal semantics of a modeling language](https://www.researchgate.net/publication/221223569_A_Lightweight_Approach_for_Defining_the_Formal_Semantics_of_a_Modeling_Language)| Model Driven Engineering Languages and Systems, 2008 - Springer|P Kelsen...|
| [Assessing the Kodkod model finder for resolving model inconsistencies](https://www.researchgate.net/publication/220989602_Assessing_the_Kodkod_Model_Finder_for_Resolving_Model_Inconsistencies) | Modelling Foundations and ..., 2011 - Springer |R Van Der Straeten, J Pinna Puissant...|
...
|[Toward a lightweight model of BGP safety](https://www.cs.princeton.edu/~jrex/papers/bgp-wripe11.pdf)| Int Workshop on Rigorous Protocol Engineering 2011|M Arye, R Harrison, R Wang, P Zave, J Rexford|
|[Using Lightweight Modeling To Understand Chord](http://www.pamelazave.com/chord-ccr.pdf)| 2009 - public.research.att.com|P Zave|
|[Analyzing the Fundamental Liveness Property of the Chord Protocol](https://hal.archives-ouvertes.fr/hal-01862755/document)| 2018 - HAL open science|J Brunel, D Chemouil, J Tawa|
|[Reasoning about Identifier Spaces: How to make Chord Correct](http://www.pamelazave.com/TSE_Chord_final.pdf)| 2011 - research.att.com|P Zave|
|[Compositional binding in network domains](http://www.pamelazave.com/fm06.pdf)| International Symposium on Formal Methods, 2006 - public.research.att.com|P Zave|
|[A formal model of addressing for interoperating networks](http://www.pamelazave.com/interop.pdf)| International Symposium of Formal Methods Europe, 2005|P Zave|
...
|[Automation of Model-Based Testing through Model Transformations](https://www.computer.org/csdl/proceedings-article/taic-part/2009/3820a063/12OmNzVoBOU)| Testing: Academic and Industrial ..., 2009 - ieeexplore.ieee.org|EG Aydal...|
|[Automated SQL query generation for systematic testing of database engines](https://www.researchgate.net/publication/220883992_Automated_SQL_query_generation_for_systematic_testing_of_database_engines)| ... of the IEEE/ACM international conference ..., 2010 - dl.acm.org|S Abdul Khalek...|
|[Putting formal specifications under the magnifying glass: Model-based testing for validation](https://www.researchgate.net/publication/33052028_Putting_Formal_Specifications_under_the_Magnifying_Glass_Model-based_Testing_for_Validation)| ... Testing Verification and ..., 2009 - ieeexplore.ieee.org|EG Aydal, RF Paige, M Utting...|
|[Pairwise testing for software product lines: comparison of two approaches](https://www.researchgate.net/publication/215588544_Pairwise_Testing_for_Software_Product_Lines_Comparison_of_Two_Approaches) |Software Quality ..., 2011 - Springer | G Perrouin, S Oster, S Sen, J Klein, B Baudry... |
|[Pairwise testing of dynamic composite services](https://hal.inria.fr/hal-00641340/document)| Proceeding of the 6th ..., 2011 - hal.inria.fr|A Kattepur, S Sen, B Baudry, A Benveniste...|
|[Systematic Testing of Database Engines Using a Relational Constraint Solver](http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.369.7923&rep=rep1&type=pdf)| Software Testing, Verification and ..., 2011 - ieeexplore.ieee.org|SA Khalek...|
| [Test data generation for web application using a UML class diagram with OCL constraints](https://www.researchgate.net/publication/220245773_Test_data_generation_for_web_application_using_a_UML_class_diagram_with_OCL_constraints)| Innovations in Systems ..., 2011 - Springer|S Fujiwara, K Munakata, Y Maeda... |
|[Relational Constraint Driven Test Case Synthesis for Web Applications](https://arxiv.org/pdf/1009.3713)| Arxiv preprint arXiv:1009.3713, 2010 - arxiv.org|X Fu|
...
| [Reliable dynamic reconfigurations in a reflective component model](https://www.springerprofessional.de/en/reliable-dynamic-reconfigurations-in-a-reflective-component-mode/3297784) |Component-Based Software ..., 2010 - Springer | M Leger, T Ledoux... |
...
| [Contract-Based Data Structure Repair Using Alloy](https://repositories.lib.utexas.edu/handle/2152/ETD-UT-2010-05-1055) |ECOOP 2010-Object-Oriented ..., 2010 - Springer |R Nokhbeh Zaeem...|
| [Supporting change propagation in the evolution of enterprise architectures](https://ieeexplore.ieee.org/document/5630232) |Enterprise Distributed Object ..., 2010 |HK Dam, LS Le... - g|
|[Formal Logic Based Configuration Modeling and Verification for Dynamic Component Systems](http://www.thinkmind.org/download.php?articleid=mopas_2011_1_30_50005)| MOPAS 2011, The Second ..., 2011 - thinkmind.org|Z Theisz, G Batori...|
| [A formal approach to software synthesis for architectural platforms](https://ieeexplore.ieee.org/document/6032615)| 33rd International Conference on Software Engineering, 2011 | H Bagheri |
|[Network configuration management via model finding](https://www.usenix.org/legacy/event/lisa05/tech/full_papers/narain/narain.pdf)| Proceedings of the 19th conference on Large ..., 2005 - dl.acm.org|S Narain|
...
| [Safety process improvement with POSE and Alloy](https://www.springerprofessional.de/en/safety-process-improvement-with-pose-and-alloy/2883004) | Improvements in System Safety, 2008 - Springer |D Mannering, JG Hall...|
